...
<div class="container">
    ...
    <table class="table table-success table-striped table-bordered">
        ...
        <tbody>
            <?php $no=1;
             date_default_timezone_set('Asia/Jakarta'); //: Baris ini mengatur zona waktu default dalam skrip PHP Anda ke "Asia/Jakarta". 
             $date = date('y-m-d- H:i:s'); //untuk mendapatkan tanggal dan waktu saat ini dalam format tertentu. 
            ?>
            <?php foreach ($data['pinjam'] as $row) :?>
                <tr>
                  ...
                  <td>
                    <?php
                        $tgl_kembali = strtotime($row["tgl_kembali"]); //ntuk mengkonversi string yang mengandung tanggal dan waktu ke dalam format UNIX timestamp. 
